    ...
    <div className="pt-32 pb-20 bg-black">
      ...
      <section className="section-padding px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12" data-aos="fade-up">
            <h1 className="text-5xl md:text-6xl font-bold mb-8 text-[#FFBB33]">
              About Us
            </h1>
      ...
      <section className="section-padding px-6 bg-gradient-to-b from-black to-[#1a1a1a]">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-4xl font-bold text-center mb-16 text-[#FFBB33]" data-aos="fade-up">
            What We Stand For
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-[#FFBB33]/10 to-transparent p-8 rounded-lg border border-[#FFBB33]/20" data-aos="fade-right">
              <h3 className="text-2xl font-bold mb-4 text-[#FFBB33]">Affordable Fashion</h3>
            ...
            <div className="bg-gradient-to-br from-[#FFBB33]/10 to-transparent p-8 rounded-lg border border-[#FFBB33]/20" data-aos="fade-left">
              <h3 className="text-2xl font-bold mb-4 text-[#FFBB33]">Everyday Comfort</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-[#FFBB33]/10 to-transparent p-8 rounded-lg border border-[#FFBB33]/20" data-aos="fade-right">
              <h3 className="text-2xl font-bold mb-4 text-[#FFBB33]">Trending Designs</h3>
              <p className="text-gray-400 leading-relaxed">
            ...
            <div className="bg-gradient-to-br from-[#FFBB33]/10 to-transparent p-8 rounded-lg border border-[#FFBB33]/20" data-aos="fade-left">
              <h3 className="text-2xl font-bold mb-4 text-[#FFBB33]">For Everyone</h3>
              <p className="text-gray-400 leading-relaxed">
